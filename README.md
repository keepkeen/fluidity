...
一款优雅的浏览器新标签页扩展：iOS 风格主屏（小组件 + 应用图标）、AI 智能助手、主题生成、浏览时长分析。

## 功能特性

### 核心功能
- **iOS 风格主屏** - 小组件与应用图标同网格，长按抖动编辑、拖拽排序、✕ 删除
- **注意力排序** - 新链接默认按使用频率（frecency）排列，手动顺序持久化并跨设备同步
- **通知中心** - 顶部横幅动画提醒，下拉查看历史消息
- **命令面板** - 按 `/` 键快速搜索链接；多搜索引擎与快捷词跳转
...
### 效率工具
- **重逢卡片** - 每天轮流展示被遗忘的收藏，帮你想起它们
- **周报/月报** - 自动生成使用统计报告
- **快捷词跳转** - 输入关键词直接跳转到指定网站
- **隐私控制** - 浏览时长统计默认关闭，启用时才请求网站访问权限
